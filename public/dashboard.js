...
• Total Acumulado (Pacientes-Dia): ${totalMesOcupacao} pac-dia

2. PERFIL DE RISCO ASSISTENCIAL (NEWS / PEWS ACUMULADO):
• Pacientes Estáveis / Baixo Risco: ${indicadoresMensais.estavel + indicadoresMensais.baixo}
• Pacientes de Médio Risco: ${indicadoresMensais.medio}
• Pacientes de Alto Risco: ${indicadoresMensais.alto}
• Alertas de Sepse Registrados: ${indicadoresMensais.sepse}

3. BALANÇO DE SAÍDAS E DESTINOS:
• Altas Hospitalares: ${totalAltas}
